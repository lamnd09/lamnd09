...
**Lam Nguyen** is a Senior Solution Architect, and experienced Software/DevOps Engineer. He has worked on the integration of Blockchain, IoT and AI/ML systems for over 8+ years at Web3-based AI startups, e.g, **FLock** as well as well-known companies e.g. **Siemens**, Munich, CNT Denmark, **Samsung&SNU** South Korea, and Singapore. 
...
:rocket: **Co-Founder** Co-founder and CTO of Adu-9, IoT smart door startup

:hearts: Familiar with API system design, DBs, e.g, MongoDB, PostgreSQL, languages Python, Solidity, Nodejs, Golang, etc. 
...
:notebook_with_decorative_cover: Interested to work with Blockchain, NFT, Distributed Learning, Marketplace, DAPPs
 ...
 <div>
  <img align="right" alt="GIF" src="https://github.com/abhisheknaiidu/abhisheknaiidu/raw/master/code.gif?raw=true" width="400" height="320" />
</div>

<h2> Happy to Contribute <img src='https://raw.githubusercontent.com/ShahriarShafin/ShahriarShafin/main/Assets/handshake.gif' width="100px"> </h2>
